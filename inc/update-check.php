...
function yai_show_update_notice() {
    ...
    if ( version_compare( $latest, YAI_VERSION, '>' ) ) {
        echo '<div class="notice notice-info yai-update-notice">&#x1F195; <strong>YOURLS Alternative Index</strong>: New version available: <strong>' . yourls_esc_attr( $latest ) . '</strong>! <a href="' . yourls_esc_url( $release['html_url'] ) . '" target="_blank">View details on GitHub</a></div>';
    }
}
